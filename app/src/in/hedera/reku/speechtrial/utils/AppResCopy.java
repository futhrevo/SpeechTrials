...
public class AppResCopy {
    ...
    private static String envWorkSpace = in.hedera.reku.speechtrial.utils.Constants.DEFAULT_WORK_SPACE;
    ...
    public static void copyResFromAssetsToSD(Context context) {
        copyFilesFromAssets(context, in.hedera.reku.speechtrial.utils.Constants.ASSETS_RES_DIR, envWorkSpace, true);
    }
}
